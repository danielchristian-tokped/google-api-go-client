...
is done with the new impersonate package. Existing users of the experimental [option.ImpersonateCredentials](https://pkg.go.dev/github.com/danielchristian-tokped/google-api-go-client/option#ImpersonateCredentials)
should consider migrating code to use this new package. See [this example](https://pkg.go.dev/github.com/danielchristian-tokped/google-api-go-client/impersonate#example-CredentialsTokenSource-ServiceAccount)
...
- Package `github.com/danielchristian-tokped/google-api-go-client/sql/v1beta4` has been deprecated as it was
  generated under the wrong name. This package will be removed in a future
  release. Please migrate to: `github.com/danielchristian-tokped/google-api-go-client/sqladmin/v1beta4`.
...
- Allow host:port for endpoint overrides, rather than requiring the full base URL (for github.com/danielchristian-tokped/google-api-go-client clients).
...
- Performance improvements to github.com/danielchristian-tokped/google-api-go-client/support/bundler.
